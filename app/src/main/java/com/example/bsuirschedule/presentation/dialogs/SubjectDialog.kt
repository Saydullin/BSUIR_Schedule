package com.example.bsuirschedule.presentation.dialogs
...
import com.example.bsuirschedule.databinding.SubjectDialogBinding
...
import com.example.bsuirschedule.presentation.adapters.SubjectItemsAdapter
...
class SubjectDialog(private val subject: ScheduleSubject): DialogFragment() {
    ...
    override fun onCreateView(
        ...
        if (subject.employees != null && subject.employees.isNotEmpty()) {
