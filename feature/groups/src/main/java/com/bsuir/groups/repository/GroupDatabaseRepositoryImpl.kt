...
import com.bsuir.groups.mapper.GroupEntityToDomainMapper
import com.bsuir.groups.mapper.GroupToEntityMapper
...
class GroupDatabaseRepositoryImpl @Inject constructor(
    ...
    override suspend fun getGroupById(id: Long): Resource<Group?> {
        return Resource.tryWithSuspend {
